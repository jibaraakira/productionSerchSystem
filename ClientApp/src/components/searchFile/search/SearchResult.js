...
export class SearchResult extends React.Component {
  ...
  resultView(resultCards) {
    ...
    if (searchResult.resultList === null) return null;
    if (!searchResult.searchIsDone) return null;
    let length = searchResult.resultList.list.length;
    let resultMessage = (
      <div>
  ...
  render() {
    let searchIsDone = this.props.init.searchResult.searchIsDone;
